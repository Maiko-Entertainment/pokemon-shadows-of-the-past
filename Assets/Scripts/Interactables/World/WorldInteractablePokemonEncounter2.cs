...
public class WorldInteractablePokemonEncounter2 : WorldInteractable
{
    public WorldMapPokemonEncounterCategory encounterCategory;
    ...
    public PokemonEncounter SelectRandomEncounter()
    {
        ...
        WorldMapPokemonEncounter encounter = WorldMapMaster.GetInstance().GetCurrentMap().GetWorldMapPokemonEncounter(encounterCategory);
        int total = 0;
        if (encounter == null)
        {
            return null;
        }
        List<PokemonEncounter> possibleEncounters = encounter.possibleEncounters;
